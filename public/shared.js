...
<div class="nr">
  ...
  <a href="#" class="btn btn-p btn-sm" onclick="window.datafast?.('cta_get_started');if(typeof openS==='function'){openS()}else{window.location.href='/index.html?start=1'};return false"><span class="en">Get Started</span><span class="he">בואו נתחיל</span></a>
</div>`;
...
function renderWhatsApp() {
  ...
  wa.addEventListener('click', function() { window.datafast?.('whatsapp_click'); });
